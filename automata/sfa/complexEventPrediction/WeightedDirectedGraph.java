...
public static double getPro(PSTree.PSTTree<String> PSTree, String leaf, String predicaite,String[] weatherPredicates){
    ...
    public static WeightedDirectedGraph  transToPSA(PSTree.PSTTree<String> PSTree, int memThreadShold,String[] weatherPredicate){
